...
import com.alibaba.nacos.multidatasource.condition.ConditionOnExternalOracleStorage;
...
/**
 * Oracle External Storage Persist Service.
 *
 * @author Long Yu
 */
@SuppressWarnings(value = {"PMD.MethodReturnWrapperTypeRule", "checkstyle:linelength"})
@Conditional(value = {ConditionOnExternalStorage.class, ConditionOnExternalOracleStorage.class})
@Component
public class OracleExternalStoragePersistServiceImpl extends DefaultDialectExternalStoragePersistServiceImpl implements PersistService {

    public static final String DEFAULT_NAMESPACE_ID = com.alibaba.nacos.api.common.Constants.DEFAULT_NAMESPACE_ID;
    ...
    public void updateMd5(String dataId, String group, String tenant, String md5, Timestamp lastTime) {
        String tenantTmp = StringUtils.isBlank(tenant) ? DEFAULT_NAMESPACE_ID : tenant;
        try {
            jt.update(
    ...
    public void removeConfigInfo4Beta(final String dataId, final String group, final String tenant) {
        final String tenantTmp = StringUtils.isBlank(tenant) ? DEFAULT_NAMESPACE_ID : tenant;
        tjt.execute(status -> {
            try {
    ...
    public Page<ConfigInfoBase> findConfigInfoBaseByGroup(final int pageNo, final int pageSize, final String group) {
        ...
        try {
            return helper.fetchPage("SELECT count(*) FROM config_info WHERE group_id=? AND tenant_id=?",
                    ...
                    new Object[] {group, DEFAULT_NAMESPACE_ID}, pageNo, pageSize, CONFIG_INFO_BASE_ROW_MAPPER);
        } catch (CannotGetJdbcConnectionException e) {
            LogUtil.FATAL_LOG.error("[db-error] " + e.toString(), e);
            throw e;
        }
    ...
    public List<String> getTenantIdList(int page, int pageSize) {
        ...
        return jt.queryForList(sql, String.class, DEFAULT_NAMESPACE_ID, getPagePrevNum(page, pageSize), getPageLastNum(page, pageSize));
    }
    ...
    public Page<ConfigInfoBase> findConfigInfoBaseLike(final int pageNo, final int pageSize, final String dataId,
        ...
        List<String> params = new ArrayList<String>();
        params.add(DEFAULT_NAMESPACE_ID);
    ...
    public long addConfigInfoAtomic(final long configId, final String srcIp, final String srcUser,
        ...
        final String tenantTmp =
                StringUtils.isBlank(configInfo.getTenant()) ? DEFAULT_NAMESPACE_ID : configInfo.getTenant();
        ...
        try {
            String[] returnPrimaryKeys = databaseDialect.getReturnPrimaryKeys();
    ...
    public int tenantInfoCountByTenantId(String tenantId) {
        ...
        String tenantTmp = StringUtils.isBlank(tenantId) ? DEFAULT_NAMESPACE_ID : tenantId;
